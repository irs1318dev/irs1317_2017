...
/**
 * Main class for the FRC 2017 Steamworks Competition Robot for IRS1318 - [robot
 * name]
 * 
 * 
 * The VM is configured to automatically run this class, and to call the
 * functions corresponding to each mode, as described in the IterativeRobot
 * documentation. If you change the name of this class or the package, you must
 * also update the manifest file in the resource directory.
 * 
 * 
 * General design comments: We have three types of objects: - Driver - describes
 * the driver/operator of the robot ("autonomous" or "user") - Components -
 * describe the electronics of an mechanism and defines the abstract way to
 * control those electronics. - Controllers - define the logic that controls a
 * mechanism given inputs/outputs.
 * 
 * @author Will
 */
public class Robot extends IterativeRobot
{
    ...
    // Driver. This could either be the UserDriver (joystick) or the
    // AutonomousDriver
    ...
    /**
     * Robot-wide initialization code should go here. This default Robot-wide
     * initialization code will be called when the robot is first powered on. It
     * will be called exactly 1 time.
     */
    ...
    /**
     * Initialization code for disabled mode should go here. This code will be
    ...
    /**
     * Initialization code for autonomous mode should go here. This code will be
     * called each time the robot enters autonomous mode.
     */
    public void autonomousInit()
    {
        // reset the position manager so that we consider ourself at the origin
        // (0,0) and facing the 0 direction.
    ...
    /**
     * Initialization code for teleop mode should go here. This code will be
    ...
    /**
     * Periodic code for disabled mode should go here. This code will be called
    ...
    /**
     * Periodic code for autonomous mode should go here. This code will be
     * called periodically at a regular rate while the robot is in autonomous
     * mode.
     */
    ...
    /**
     * Periodic code for teleop mode should go here. This code will be called
