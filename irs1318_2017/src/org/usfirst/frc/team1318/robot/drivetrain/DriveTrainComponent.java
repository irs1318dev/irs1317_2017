...
/**
 * The drivetrain component class describes the electronics of the drivetrain
 * and defines the abstract way to control it. The drivetrain electronics
 * include two motors (left and right), and two encoders (left and right).
 * 
 */
@Singleton
public class DriveTrainComponent
{
    public static final String LogName = "dt";
     ...
     * 
     * @param leftPower
     *            level to apply to the left motor
     * @param rightPower
     *            level to apply to the right motor
     */
    public void setDriveTrainPower(double leftPower, double rightPower)
    {
        ...
        double outRightPower = -rightPower;// note: right motors are oriented
                                           // facing "backwards"
